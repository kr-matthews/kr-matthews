...
My current work is on smart TVs with **React** (and briefly with **Preact**, a light-weight version), where my focus is on improvement state management and performance, assisted at times by AI (primarily **Cursor**).
Before that, I was on an **Android** project using **Kotlin**, where I primarily worked on introducing **Jetpack Compose** to the project and replacing the existing xml-based views (including charts and graphs), as well as fixing/expanding unit tests.
...
I'm currently working through various [personal projects](https://kr-matthews.github.io/projects), primarily **React web apps**, and also recently **Kotlin Android apps**, with the aim of improving my skills and learning new ones.
These include a personal website, a blog, various games (such as minesweeper, connect 4, and cribbage), and an app leveraging the Strava API.
